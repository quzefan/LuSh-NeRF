...
if __name__ == '__main__':
    ...
    if args.model == 'gim_dkm':
        ...
        model = DKMv3(weights=None, h=1120, w=640)
    ...
    image_dir = "D:\Code/nir\OPPO\Cafe\images"
    ...
    image_vis0 = read_image(img_path0)
    image_vis1 = read_image(img_path1)
    
    coordx0 = kpts0[1200]
    
    coordx1 = kpts1[1200]
    
    patch1 = image_vis0[int(coordx0[0]) - 64:int(coordx0[0]) + 64, int(coordx0[1]) - 64:int(coordx0[1]) + 64]
    
    patch2 = image_vis1[int(coordx1[0]) - 64:int(coordx1[0]) + 64, int(coordx1[1]) - 64:int(coordx1[1]) + 64]
    
    # # 保存裁切的patches  
    # cv2.imwrite('D:\Code/nir\OPPO\Dorm8\Images/002.jpg', patch1)  
    # cv2.imwrite('D:\Code/nir\OPPO\Dorm8\Images/007.jpg', patch2)
